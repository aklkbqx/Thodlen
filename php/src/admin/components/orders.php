...
<div class="d-flex justify-content-center">
    <ul class="m-0 p-0 list-unstyled d-flex flex-row gap-4">
        ...
        foreach ($ordersTabsName as $index => $tabname) { ?>
            <a href="/admin/?page=orders&tabs=<?= $tabname; ?>" class="text-decoration-none text-cyan fs-5 fw-medium btn rounded-3 <?= isset($_GET["tabs"]) && $_GET["tabs"] == $tabname ? "active btn-outline-cyan" : "btn-light" ?>">
                <li>
                    <?php
