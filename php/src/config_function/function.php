...
if (isset($_REQUEST["logout"])) {
    ...
    if ($session_check) {
        ...
        msg("ออกจากระบบเสร็จสิ้น!", 'success', "../");
    }
}
...
function showMessageAlert(string $type_msg)
{
    if (isset($_SESSION[$type_msg])) { ?>
        <div class='position-fixed opacity-0' style="top:0rem;right:2rem;z-index:99999" id="showMsg">
            <div class='alert alert-<?= $type_msg; ?> border border-<?= $type_msg; ?> border-3 position-relative p-4 shadow-sm rounded-3' style='width:350px;'>
